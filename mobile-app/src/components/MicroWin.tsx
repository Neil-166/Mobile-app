  ...
  toast.custom(
    () => (
      <motion.div
        ...
        role="status"
        aria-live="polite"
        className="pointer-events-auto flex items-center gap-3 rounded-2xl border border-border bg-surface/95 px-4 py-3 shadow-[0_8px_24px_rgba(0,0,0,0.16)] backdrop-blur-md"
      >
