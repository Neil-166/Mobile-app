  ...
  toast.custom(
    () => (
      <motion.div
        ...
        role="status"
        aria-live="polite"
        className="pointer-events-auto flex items-center gap-3 rounded-2xl border border-white/10 bg-[#16161D]/95 px-4 py-3 shadow-2xl shadow-black/50 backdrop-blur-md"
      >
        <span className="grid h-8 w-8 shrink-0 place-items-center rounded-full bg-[#8B5CF6]/15 text-base">
          {emoji}
        </span>
